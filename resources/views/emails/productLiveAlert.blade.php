                ...
                <div class="full-wrap">
                  <img  src="{{ url('img/speedy-logo-3.png') }}">
                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="text-area">
                                <p>This handy tool helps you create dummy text for all your layout needs.</p><p>We are gradually adding new functionality and we welcome your suggestions and feedback.</p>
                        </div>
